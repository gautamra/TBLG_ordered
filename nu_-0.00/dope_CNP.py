...
parser.add_argument("--dm_update_every", help="Number of iterations to keep dm constant default:1", type = int)
...
for iteration_number in range(1,loops+1):
    ...
    if not args.dm_update_every or iteration_number%args.dm_update_every==0:
        dm = {}
